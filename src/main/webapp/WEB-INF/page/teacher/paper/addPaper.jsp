...
<head>
	...
	<script src="/js/teacher/paper/addPaper.js"></script>
</head>
...
<div id="operation" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<div class="table-responsive">
		<select id="id_subject" onchange="subjectChange(this)">
		</select>

		<div class="form-group">
			<div class="col-xs-3">
				<label for="exampleInputAmount">试卷名称</label>
				<input type="text" class="form-control" id="paperName" placeholder="试卷名称" >
			</div>
		</div>
		<div class="form-group">
			<div class="col-xs-3">
				<label for="exampleInputAmount">考试时间</label>
				<input type="text" class="form-control" id="paper_time" placeholder="考试时间" >
			</div>
		</div>
